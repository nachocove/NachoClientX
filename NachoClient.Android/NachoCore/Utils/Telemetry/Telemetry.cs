...
namespace NachoCore.Utils
{
    public partial class Telemetry
    {
        ...
        private ITelemetryBE TelemetryBackEnd;
        ...
        {
            try {
                TelemetryBackEnd = new TelemetryBEAWS ();
                TelemetryBackEnd.Initialize ();
                ...
                while (true) {
                    ...
                    if (null != readFile) {
                        ...
                        succeed = TelemetryBackEnd.UploadEvents (readFile);
                        if (succeed) {
