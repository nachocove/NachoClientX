...
namespace NachoCore
{
	public sealed class BackEnd : IBackEnd, IProtoControlOwner
	{
		...
		public string MoveFolder (int accountId, int folderId, int destFolderId)
		{
			return ServiceFromAccountId (accountId).MoveFolder (folderId, destFolderId);
		}

		public string RenameFolder (int accountId, int folderId, string displayName)
		{
			return ServiceFromAccountId (accountId).RenameFolder (folderId, displayName);
		}
