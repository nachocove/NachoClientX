                ...
                TransTable = new[] {
                    ...
                    new Node {
                        ...
                        On = new [] {
                            ...
                            new Trans { Event = (uint)SmEvt.E.HardFail, Act = DoNop, State = (uint)Lst.Parked },
                            new Trans { Event = (uint)SmEvt.E.TempFail, Act = DoNop, State = (uint)Lst.Parked },
                            new Trans { Event = (uint)AsEvt.E.ReProv, Act = DoNop, State = (uint)Lst.Parked },
                            new Trans { Event = (uint)AsEvt.E.ReSync, Act = DoNop, State = (uint)Lst.Parked },
                            new Trans { Event = (uint)AsEvt.E.AuthFail, Act = DoNop, State = (uint)Lst.Parked },
                            new Trans { Event = (uint)AsEvt.E.ReDisc, Act = DoDisc, State = (uint)Lst.DiscW },
                            new Trans { Event = (uint)CtlEvt.E.GetServConf, Act = DoNop, State = (uint)Lst.Parked },
                            new Trans { Event = (uint)CtlEvt.E.GetCertOk, Act = DoNop, State = (uint)Lst.Parked },
                            new Trans { Event = (uint)CtlEvt.E.ReFSync, Act = DoNop, State = (uint)Lst.Parked },
                        }
                    },
                }
            };
