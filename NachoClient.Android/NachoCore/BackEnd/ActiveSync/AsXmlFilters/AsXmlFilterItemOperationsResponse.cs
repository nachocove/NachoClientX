...
namespace NachoCore.Wbxml
{
    public class AsXmlFilterItemOperationsResponse : NcXmlFilter
    {
        public AsXmlFilterItemOperationsResponse () : base ("ItemOperations")
        {
            ...
            // ConversationId
            node4 = new NcXmlFilterNode ("ConversationId", RedactionType.FULL, RedactionType.FULL);
            ...
            // Range
            node5 = new NcXmlFilterNode ("Range", RedactionType.FULL, RedactionType.FULL);
            node4.Add(node5); // Properties -> Range
            // Total
            node5 = new NcXmlFilterNode ("Total", RedactionType.FULL, RedactionType.FULL);
            ...
            // Part
            node5 = new NcXmlFilterNode ("Part", RedactionType.FULL, RedactionType.FULL);
            node4.Add(node5); // Properties -> Part
            // Version
            node5 = new NcXmlFilterNode ("Version", RedactionType.FULL, RedactionType.FULL);
