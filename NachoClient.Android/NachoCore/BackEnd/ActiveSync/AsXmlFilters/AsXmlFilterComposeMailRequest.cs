...
namespace NachoCore.Wbxml
{
    public class AsXmlFilterComposeMailRequest : NcXmlFilter
    {
        public AsXmlFilterComposeMailRequest () : base ("ComposeMail")
        {
            ...
            // SaveInSentItems
            node1 = new NcXmlFilterNode ("SaveInSentItems", RedactionType.FULL, RedactionType.FULL);
            node0.Add(node1); // xml -> SaveInSentItems
            // ReplaceMime
            node1 = new NcXmlFilterNode ("ReplaceMime", RedactionType.FULL, RedactionType.FULL);
            ...
            // FolderId
            node2 = new NcXmlFilterNode ("FolderId", RedactionType.FULL, RedactionType.FULL);
            node1.Add(node2); // Source -> FolderId
            // ItemId
            node2 = new NcXmlFilterNode ("ItemId", RedactionType.FULL, RedactionType.FULL);
            node1.Add(node2); // Source -> ItemId
            // LongId
            node2 = new NcXmlFilterNode ("LongId", RedactionType.FULL, RedactionType.FULL);
            node1.Add(node2); // Source -> LongId
            // InstanceId
            node2 = new NcXmlFilterNode ("InstanceId", RedactionType.FULL, RedactionType.FULL);
            ...
            // ClientId
            node2 = new NcXmlFilterNode ("ClientId", RedactionType.FULL, RedactionType.FULL);
            ...
            // SaveInSentItems
            node2 = new NcXmlFilterNode ("SaveInSentItems", RedactionType.FULL, RedactionType.FULL);
            ...
            // FolderId
            node3 = new NcXmlFilterNode ("FolderId", RedactionType.FULL, RedactionType.FULL);
            node2.Add(node3); // Source -> FolderId
            // ItemId
            node3 = new NcXmlFilterNode ("ItemId", RedactionType.FULL, RedactionType.FULL);
            node2.Add(node3); // Source -> ItemId
            // LongId
            node3 = new NcXmlFilterNode ("LongId", RedactionType.FULL, RedactionType.FULL);
            ...
            // ReplaceMime
            node2 = new NcXmlFilterNode ("ReplaceMime", RedactionType.FULL, RedactionType.FULL);
