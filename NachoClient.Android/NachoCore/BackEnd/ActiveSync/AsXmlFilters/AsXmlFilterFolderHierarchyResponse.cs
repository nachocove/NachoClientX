...
namespace NachoCore.Wbxml
{
    public class AsXmlFilterFolderHierarchyResponse : NcXmlFilter
    {
        public AsXmlFilterFolderHierarchyResponse () : base ("FolderHierarchy")
        {
            ...
            // ParentId
            node1 = new NcXmlFilterNode ("ParentId", RedactionType.FULL, RedactionType.FULL);
            ...
            // SyncKey
            node2 = new NcXmlFilterNode ("SyncKey", RedactionType.FULL, RedactionType.FULL);
            ...
            // Count
            node3 = new NcXmlFilterNode ("Count", RedactionType.FULL, RedactionType.FULL);
            node2.Add(node3); // Changes -> Count
            // Update
            node3 = new NcXmlFilterNode ("Update", RedactionType.NONE, RedactionType.NONE);
            // ServerId
            node4 = new NcXmlFilterNode ("ServerId", RedactionType.FULL, RedactionType.FULL);
            node3.Add(node4); // Update -> ServerId
            // ParentId
            node4 = new NcXmlFilterNode ("ParentId", RedactionType.FULL, RedactionType.FULL);
