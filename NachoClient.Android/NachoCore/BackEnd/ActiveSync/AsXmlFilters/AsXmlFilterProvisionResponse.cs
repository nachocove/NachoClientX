...
namespace NachoCore.Wbxml
{
    public class AsXmlFilterProvisionResponse : NcXmlFilter
    {
        public AsXmlFilterProvisionResponse () : base ("Provision")
        {
            ...
            // DevicePasswordEnabled
            node6 = new NcXmlFilterNode ("DevicePasswordEnabled", RedactionType.FULL, RedactionType.FULL);
            node5.Add(node6); // EASProvisionDoc -> DevicePasswordEnabled
            // AlphanumericDevicePasswordRequired
            node6 = new NcXmlFilterNode ("AlphanumericDevicePasswordRequired", RedactionType.FULL, RedactionType.FULL);
            node5.Add(node6); // EASProvisionDoc -> AlphanumericDevicePasswordRequired
            // PasswordRecoveryEnabled
            node6 = new NcXmlFilterNode ("PasswordRecoveryEnabled", RedactionType.FULL, RedactionType.FULL);
            node5.Add(node6); // EASProvisionDoc -> PasswordRecoveryEnabled
            // RequireStorageCardEncryption
            node6 = new NcXmlFilterNode ("RequireStorageCardEncryption", RedactionType.FULL, RedactionType.FULL);
            node5.Add(node6); // EASProvisionDoc -> RequireStorageCardEncryption
            // AttachmentsEnabled
            node6 = new NcXmlFilterNode ("AttachmentsEnabled", RedactionType.FULL, RedactionType.FULL);
            node5.Add(node6); // EASProvisionDoc -> AttachmentsEnabled
            // MinDevicePasswordLength
            node6 = new NcXmlFilterNode ("MinDevicePasswordLength", RedactionType.FULL, RedactionType.FULL);
            node5.Add(node6); // EASProvisionDoc -> MinDevicePasswordLength
            // MaxInactivityTimeDeviceLock
            node6 = new NcXmlFilterNode ("MaxInactivityTimeDeviceLock", RedactionType.FULL, RedactionType.FULL);
            node5.Add(node6); // EASProvisionDoc -> MaxInactivityTimeDeviceLock
            // MaxDevicePasswordFailedAttempts
            node6 = new NcXmlFilterNode ("MaxDevicePasswordFailedAttempts", RedactionType.FULL, RedactionType.FULL);
            node5.Add(node6); // EASProvisionDoc -> MaxDevicePasswordFailedAttempts
            // MaxAttachmentSize
            node6 = new NcXmlFilterNode ("MaxAttachmentSize", RedactionType.FULL, RedactionType.FULL);
            node5.Add(node6); // EASProvisionDoc -> MaxAttachmentSize
            // AllowSimpleDevicePassword
            node6 = new NcXmlFilterNode ("AllowSimpleDevicePassword", RedactionType.FULL, RedactionType.FULL);
            node5.Add(node6); // EASProvisionDoc -> AllowSimpleDevicePassword
            // DevicePasswordExpiration
            node6 = new NcXmlFilterNode ("DevicePasswordExpiration", RedactionType.FULL, RedactionType.FULL);
            node5.Add(node6); // EASProvisionDoc -> DevicePasswordExpiration
            // DevicePasswordHistory
            node6 = new NcXmlFilterNode ("DevicePasswordHistory", RedactionType.FULL, RedactionType.FULL);
            node5.Add(node6); // EASProvisionDoc -> DevicePasswordHistory
            // AllowStorageCard
            node6 = new NcXmlFilterNode ("AllowStorageCard", RedactionType.FULL, RedactionType.FULL);
            node5.Add(node6); // EASProvisionDoc -> AllowStorageCard
            // AllowCamera
            node6 = new NcXmlFilterNode ("AllowCamera", RedactionType.FULL, RedactionType.FULL);
            node5.Add(node6); // EASProvisionDoc -> AllowCamera
            // RequireDeviceEncryption
            node6 = new NcXmlFilterNode ("RequireDeviceEncryption", RedactionType.FULL, RedactionType.FULL);
            node5.Add(node6); // EASProvisionDoc -> RequireDeviceEncryption
            // AllowUnsignedApplications
            node6 = new NcXmlFilterNode ("AllowUnsignedApplications", RedactionType.FULL, RedactionType.FULL);
            node5.Add(node6); // EASProvisionDoc -> AllowUnsignedApplications
            // AllowUnsignedInstallationPackages
            node6 = new NcXmlFilterNode ("AllowUnsignedInstallationPackages", RedactionType.FULL, RedactionType.FULL);
            node5.Add(node6); // EASProvisionDoc -> AllowUnsignedInstallationPackages
            // MinDevicePasswordComplexCharacters
            node6 = new NcXmlFilterNode ("MinDevicePasswordComplexCharacters", RedactionType.FULL, RedactionType.FULL);
            node5.Add(node6); // EASProvisionDoc -> MinDevicePasswordComplexCharacters
            // AllowWiFi
            node6 = new NcXmlFilterNode ("AllowWiFi", RedactionType.FULL, RedactionType.FULL);
            node5.Add(node6); // EASProvisionDoc -> AllowWiFi
            // AllowTextMessaging
            node6 = new NcXmlFilterNode ("AllowTextMessaging", RedactionType.FULL, RedactionType.FULL);
            node5.Add(node6); // EASProvisionDoc -> AllowTextMessaging
            // AllowPOPIMAPEmail
            node6 = new NcXmlFilterNode ("AllowPOPIMAPEmail", RedactionType.FULL, RedactionType.FULL);
            node5.Add(node6); // EASProvisionDoc -> AllowPOPIMAPEmail
            // AllowBluetooth
            node6 = new NcXmlFilterNode ("AllowBluetooth", RedactionType.FULL, RedactionType.FULL);
            node5.Add(node6); // EASProvisionDoc -> AllowBluetooth
            // AllowIrDA
            node6 = new NcXmlFilterNode ("AllowIrDA", RedactionType.FULL, RedactionType.FULL);
            node5.Add(node6); // EASProvisionDoc -> AllowIrDA
            // RequireManualSyncWhenRoaming
            node6 = new NcXmlFilterNode ("RequireManualSyncWhenRoaming", RedactionType.FULL, RedactionType.FULL);
            node5.Add(node6); // EASProvisionDoc -> RequireManualSyncWhenRoaming
            // AllowDesktopSync
            node6 = new NcXmlFilterNode ("AllowDesktopSync", RedactionType.FULL, RedactionType.FULL);
            node5.Add(node6); // EASProvisionDoc -> AllowDesktopSync
            // MaxCalendarAgeFilter
            node6 = new NcXmlFilterNode ("MaxCalendarAgeFilter", RedactionType.FULL, RedactionType.FULL);
            node5.Add(node6); // EASProvisionDoc -> MaxCalendarAgeFilter
            // AllowHTMLEmail
            node6 = new NcXmlFilterNode ("AllowHTMLEmail", RedactionType.FULL, RedactionType.FULL);
            node5.Add(node6); // EASProvisionDoc -> AllowHTMLEmail
            // MaxEmailAgeFilter
            node6 = new NcXmlFilterNode ("MaxEmailAgeFilter", RedactionType.FULL, RedactionType.FULL);
            node5.Add(node6); // EASProvisionDoc -> MaxEmailAgeFilter
            // MaxEmailBodyTruncationSize
            node6 = new NcXmlFilterNode ("MaxEmailBodyTruncationSize", RedactionType.FULL, RedactionType.FULL);
            node5.Add(node6); // EASProvisionDoc -> MaxEmailBodyTruncationSize
            // MaxEmailHTMLBodyTruncationSize
            node6 = new NcXmlFilterNode ("MaxEmailHTMLBodyTruncationSize", RedactionType.FULL, RedactionType.FULL);
            node5.Add(node6); // EASProvisionDoc -> MaxEmailHTMLBodyTruncationSize
            // RequireSignedSMIMEMessages
            node6 = new NcXmlFilterNode ("RequireSignedSMIMEMessages", RedactionType.FULL, RedactionType.FULL);
            node5.Add(node6); // EASProvisionDoc -> RequireSignedSMIMEMessages
            // RequireEncryptedSMIMEMessages
            node6 = new NcXmlFilterNode ("RequireEncryptedSMIMEMessages", RedactionType.FULL, RedactionType.FULL);
            node5.Add(node6); // EASProvisionDoc -> RequireEncryptedSMIMEMessages
            // RequireSignedSMIMEAlgorithm
            node6 = new NcXmlFilterNode ("RequireSignedSMIMEAlgorithm", RedactionType.FULL, RedactionType.FULL);
            node5.Add(node6); // EASProvisionDoc -> RequireSignedSMIMEAlgorithm
            // RequireEncryptionSMIMEAlgorithm
            node6 = new NcXmlFilterNode ("RequireEncryptionSMIMEAlgorithm", RedactionType.FULL, RedactionType.FULL);
            node5.Add(node6); // EASProvisionDoc -> RequireEncryptionSMIMEAlgorithm
            // AllowSMIMEEncryptionAlgorithmNegotiation
            node6 = new NcXmlFilterNode ("AllowSMIMEEncryptionAlgorithmNegotiation", RedactionType.FULL, RedactionType.FULL);
            node5.Add(node6); // EASProvisionDoc -> AllowSMIMEEncryptionAlgorithmNegotiation
            // AllowSMIMESoftCerts
            node6 = new NcXmlFilterNode ("AllowSMIMESoftCerts", RedactionType.FULL, RedactionType.FULL);
            node5.Add(node6); // EASProvisionDoc -> AllowSMIMESoftCerts
            // AllowBrowser
            node6 = new NcXmlFilterNode ("AllowBrowser", RedactionType.FULL, RedactionType.FULL);
            node5.Add(node6); // EASProvisionDoc -> AllowBrowser
            // AllowConsumerEmail
            node6 = new NcXmlFilterNode ("AllowConsumerEmail", RedactionType.FULL, RedactionType.FULL);
            node5.Add(node6); // EASProvisionDoc -> AllowConsumerEmail
            // AllowRemoteDesktop
            node6 = new NcXmlFilterNode ("AllowRemoteDesktop", RedactionType.FULL, RedactionType.FULL);
            node5.Add(node6); // EASProvisionDoc -> AllowRemoteDesktop
            // AllowInternetSharing
            node6 = new NcXmlFilterNode ("AllowInternetSharing", RedactionType.FULL, RedactionType.FULL);
            ...
            // ApplicationName
            node7 = new NcXmlFilterNode ("ApplicationName", RedactionType.FULL, RedactionType.FULL);
            ...
            // Hash
            node7 = new NcXmlFilterNode ("Hash", RedactionType.FULL, RedactionType.FULL);
            ...
            // RemoteWipe
            node2 = new NcXmlFilterNode ("RemoteWipe", RedactionType.FULL, RedactionType.FULL);
