...
namespace NachoCore.Wbxml
{
    public class AsXmlFilterAirSyncResponse : NcXmlFilter
    {
        public AsXmlFilterAirSyncResponse () : base ("AirSync")
        {
            ...
            // Limit
            node2 = new NcXmlFilterNode ("Limit", RedactionType.FULL, RedactionType.FULL);
            ...
            node5.Add(node6); // Change -> ServerId
            // Status
            node6 = new NcXmlFilterNode ("Status", RedactionType.FULL, RedactionType.FULL);
            ...
            // MoreAvailable
            node4 = new NcXmlFilterNode ("MoreAvailable", RedactionType.FULL, RedactionType.FULL);
