...
namespace NachoCore.SMTP
{
    public class SmtpDisconnectCommand : SmtpCommand
    {
        ...
        {
            // Disconnect is different than the other SMTP commands.  It is run when parking
            ...
            // until any other command is done using the SmtpClient.  If the SmtpClient's lock
