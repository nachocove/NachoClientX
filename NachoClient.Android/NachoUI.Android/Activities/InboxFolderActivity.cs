...
{
    [Activity (Label = "InboxFolderActivity")]            
    public class InboxFolderActivity : MessageFolderActivity
    {
        public static Intent ShowInboxFolderIntent (Context context, McFolder folder)
        {
            var intent = new Intent (context, typeof(InboxFolderActivity));
