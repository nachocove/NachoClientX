...
namespace NachoClient.AndroidClient
{
    ...
    {
        public MyActionBarDrawerToggle (FragmentActivity activity, Android.Support.V4.Widget.DrawerLayout drawerLayout, int drawerImageRes, int openDrawerContentDescRes, int closeDrawerContentDescRes)
