...
{
    public class HierarchicalFolderTableSource  : UITableViewDataSource
    {
    ...
    {
        HierarchicalFolderTableSource v;

        private SearchDisplayDelegate ()
        {
        }

        public SearchDisplayDelegate (HierarchicalFolderTableSource owner)
        {
            v = owner;
        }
