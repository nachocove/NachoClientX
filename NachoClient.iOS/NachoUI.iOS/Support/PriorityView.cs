...
//    public class PriorityView: UIView, INachoDateController
//    {
//        private List<UIButton> ActionButtons = new List<UIButton> ();
//        INachoDateControllerParent owner;
...
//
//        public void SetOwner (INachoDateControllerParent owner)
//        {
//            this.owner = owner;
//        }
//
...
//                new ButtonInfo ("Later Today", "cup-48", () => owner.HandleSelectedDate (MessageDeferralType.Later)),
//                new ButtonInfo ("Tonight", "navbar-icn-defer", () => owner.HandleSelectedDate (MessageDeferralType.Tonight)),
//                new ButtonInfo ("Tomorrow", "navbar-icn-defer", () => owner.HandleSelectedDate (MessageDeferralType.Tomorrow)),
//                new ButtonInfo (null, null, null),
//                new ButtonInfo ("Next Week", "navbar-icn-defer", () => owner.HandleSelectedDate (MessageDeferralType.NextWeek)),
//                new ButtonInfo ("Next Month", "navbar-icn-defer", () => owner.HandleSelectedDate (MessageDeferralType.NextMonth)),
//                new ButtonInfo ("Pick Date", "navbar-icn-defer", () => owner.HandleSelectedDate (MessageDeferralType.Custom)),
//                new ButtonInfo (null, null, null),
//                null,
//                null,
//                new ButtonInfo ("None", "navbar-icn-defer", () => owner.HandleSelectedDate (MessageDeferralType.None)),
//            });
//
