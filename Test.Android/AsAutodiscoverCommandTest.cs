    ...
    public class AsAutodiscoverCommandTest
    {
        ...
        public void ServerNotConfigured ()
        {
            ...
            PerformAutoDiscoveryWithSettings (mockContext => {
                ...
                httpResponse.Content.Headers.Add ("Content-Type", contentType);
            }, provideDnsResponse => {
...
//        }
        ...
        public void PerformAutoDiscoveryWithSettings (Action<MockContext> provideContext, Action<HttpResponseMessage> provideHttpResponse, Action<DnsQueryResponse> provideDnsResponse)
        {
            ...
            MockDnsQueryRequest.ProvideDnsQueryResponseMessage = () => {
                ...
                mockDnsQueryResponse.ParseResponse (bytearray);
            ...
            var mockResponse = CreateMockResponse (CommonMockData.MockAutodResponseXml.ToString (), response => {
