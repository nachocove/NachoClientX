...
def create_buildinfo(options):
    ...
    if version.startswith('DEV['):
        ...
        parse_app_id = 'krLhpUrvcoKXTNx8LWG8ESR1zQGRzei6vttCmwFm'
        parse_api_key = '224PvsNa7ABberuxpthahr0YIp4742VZqRgw6zT1'
        hockeyapp_app_id = 'b22a505d784d64901ab1abde0728df67'
        project_prefix = 'dev'
    else:
        source = None
        parse_app_id = 'uRVtTGj8WhhK4OJNRqKmSVg5FyS5gYXtQGIRRlqs'
        parse_api_key = 'Ae5ctpbVSvvw4kTPlANA9TN7jiZPVxzh12reqTlA'
        hockeyapp_app_id = '44dae4a6ae9134930c64c623d5023ac4'
        project_prefix = 'beta'
    with open(path, 'w') as f:
        ...
        print >>f, '        public const string ProjectPrefix = "%s";' % project_prefix
        print >>f, '    }'
        print >>f, '}'
