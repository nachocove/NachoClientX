...
def create_buildinfo(options):
    ...
    aws = projects[release]['aws']
    aws_prefix = aws['prefix']
    aws_account_id = aws['account_id']
    aws_identity_pool_id = aws['identity_pool_id']
    aws_unauth_role_arn = aws['unauth_role_arn']
    aws_auth_role_arn = aws['auth_role_arn']
    pinger_hostname = projects[release]['pinger']['hostname']
    ...
    with open(path, 'w') as f:
        ...
        print >>f, '        public const string AwsAccountId = "%s";' % aws_account_id
        print >>f, '        public const string AwsIdentityPoolId = "%s";' % aws_identity_pool_id
        print >>f, '        public const string AwsUnauthRoleArn = "%s";' % aws_unauth_role_arn
