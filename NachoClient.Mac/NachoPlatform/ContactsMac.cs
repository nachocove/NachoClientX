...
//        private ABAddressBook Ab;
        ...
        public bool AuthorizationStatus { get { return false; //ABAuthorizationStatus.Authorized == ABAddressBook.GetAuthorizationStatus (); 
            } }
...
//            }
    ...
    public class PlatformContactRecordiOS : PlatformContactRecord
    {
        public override string ServerId { get { return "";//Person.Id.ToString ();
                ...
                public override DateTime LastUpdate { get { return DateTime.Now; // Person.ModificationDate.ToDateTime ();
            } }
